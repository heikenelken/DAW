...
public class DataExampleController {
	...
	public void init(){
		...
		comicRepository.save(new Comic("Batman vs Superman", "Algun tarado", "Algun tarado", "El gran Bruce Wayne en su empeño de liarse a ostias con todo el mundo con la escusa de establecer la paz y defender su amada Gotham se enfrenta al todochulopodero Clark Kent sin gafas con traje de neopreno y capa.", "14"));
		comicRepository.save(new Comic("Wonderwoman", "Peter West", "Jack Kirby", "Mas conocida como la reina de las feminazis, esta chavala va por el mundo reventando a machistas opresores defensores del heteropatriarcado. También revienta a los pives que van despatarrados en el metro.", "15"));
		comicRepository.save(new Comic("The avengers", "Mirami Normeculo", "Medasun Besito", "Una panda de amigos superhéroes se dedican a establecer la paz mundial???", "16"));
		comicRepository.save(new Comic("Thor #001", "Stan Lee", "Stan Lee", "Este pavo se dio un dia un golpe en la cabeza con un gran martillo y ahora se cree que el susodicho martillo le hace megafuerte y peligroso.", "17"));
		comicRepository.save(new Comic("Guardians of the galaxy", "Carlos Sevilla", "Carlos Sevilla", "El argumento es que los guardianes de la galaxia son los putos amos y se pasean por el mundo haciendo cosas.", "18"));
		comicRepository.save(new Comic("Batman vs Predator", "Alguen que no está muy cuerdo", "Yo mismo", "Joder este tío no se cansa de pelear con todo el mundo, ahora la ha tomado con el pobre e inofensivo Predator. Como se nota que de pequeño no le han dado una buena colleja...", "19"));
		comicRepository.save(new Comic("Flash #200", "Len Wein", "Herb Trimpe", "Pues este menda corre a la velocidad de la luz o incluso más, si parpadeas lo vas a perder de vista yoquesetio XD", "20"));
